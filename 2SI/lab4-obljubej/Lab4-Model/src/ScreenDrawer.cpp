...
void ScreenDrawer::Draw() const
{
    ...
    for(int i = 0; i < gmRef->getBoardSizeY(); i++)
    {
        ...
        {
            case 0:             
                MacUILib_printf("Player 1 Score: %d.  Character Collection:", playerRef[0]->getScore());  // Player 1   
                break;
            case 1:
                playerRef[0]->printBinContents();
                break;
            case 2:
                break;
            ...
            case 4:
                if(playerCount >= 2)    
                    MacUILib_printf("Player 2 Score: %d.  Character Collection:", playerRef[1]->getScore());  // Player 2  
                break;
            case 5:
                if(playerCount >= 2)    
                    playerRef[1]->printBinContents();
                break;
            case 6:
                break;
            ...
            case 8:
                if(playerCount >= 3)    
                    MacUILib_printf("Player 3 Score: %d.  Character Collection:", playerRef[2]->getScore());  // Player 3                   break;
                break;
            case 9:
                if(playerCount >= 3)    
                    playerRef[2]->printBinContents();
                break;
            case 10:
                break;
            ...
            case 12:
                if(playerCount >= 4)    
                    MacUILib_printf("Player 4 Score: %d.  Character Collection:", playerRef[3]->getScore());  // Player 4                   break;
                break;
            case 13:
                if(playerCount >= 4)    
                    playerRef[3]->printBinContents();
                break;
            case 14:
...
void ScreenDrawer::DrawEndGame() const
{
    ...
    {
        if(gmRef->getWinnerID() > 0)
            MacUILib_printf("Player %d Won!\n", gmRef->getWinnerID());
        else
